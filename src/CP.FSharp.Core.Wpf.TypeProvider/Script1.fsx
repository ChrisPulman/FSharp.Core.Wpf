...
let mainViewXaml = """<UserControl     
        ...
        x:Name="Self"
        >
    <!-- fswpf:ViewController.Custom="{x:Type views:MainViewController}" -->
    <UserControl.Resources>
        <fswpf:BooleanToCollapsedConverter x:Key="TrueToCollapsed" />
    </UserControl.Resources>
...
let resourceXaml = """<ResourceDictionary
  ...
  xmlns:fswpf="https://github.com/ChrisPulman/FSharp.Core.Wpf"
    >
    <fswpf:ValidationErrorsToStringConverter x:Key="validationConverter"/>
...
let sr = generateStreamFromString mainViewXaml
